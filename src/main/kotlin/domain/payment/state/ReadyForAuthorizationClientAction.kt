...
data class ReadyForAuthorizationClientAction
(
    ...
    val authorizeResponse: AuthorizeResponse.AuthorizeClientAction,

    ): AbstractPayment(), Payment, AuthorizePending
{
    private val log = Logger.getLogger(ReadyForAuthorizationClientAction::class.java.name)
    ...
    private fun apply(event: ReturnedFromClientEvent, isNew: Boolean): Payment
    {
        ...
        return ReadyForAuthorizationConfirm(
            version = newVersion,
